...
- **Localisation** fuses wheel odometry + IMU + **RGB-D visual odometry**.
  ...
  distance to about 1%. Each sensor is used for what it is measurably good at.
  See `regolith_visual_odometry/README.md` for the accuracy measurements and
  the three defects that only real imagery exposed.
